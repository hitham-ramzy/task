...
CREATE TABLE `bill_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `item___fk` (`item_id`),
  KEY `bill___fk` (`bill_id`),
  CONSTRAINT `bill___fk` FOREIGN KEY (`bill_id`) REFERENCES `bill` (`id`),
  CONSTRAINT `item___fk` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`)
...
-- Dump completed on 2020-12-05 19:15:14
